    ...
    switch($_GET["op"]){
        case "guardaryeditar":
            if(empty($_POST["usu_id"])){       
                $usuario->insert_usuario($_POST["nombres"],$_POST["apellidos"],$_POST["correo"],$_POST["pass"],$_POST["rol_id"]);     
            }
            else {
                $usuario->update_usuario($_POST["usu_id"],$_POST["nombres"],$_POST["apellidos"],$_POST["correo"],$_POST["pass"],$_POST["rol_id"]);
            }
        break;
